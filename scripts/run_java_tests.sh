...
TEST_FILE="$ROOT_DIR/tests/java/com/example/task/TaskPriorityEngineTest.java"
SOURCE_FILE="$ROOT_DIR/src/java/com/example/task/TaskPriorityEngine.java"
TEST_CLASS="com.example.task.TaskPriorityEngineTest"
